...
const quizGame = [
  ...
  },
  {
    ...
    positiveValue: +1, //or whatever, positive value
  },
  {
    eventIndex: 12,
    question:
  ...
  },
  {
    ...
    options: [
      { a: "Piano", answerIndex: 26 },
      { b: "Puzzle", answerIndex: 25 },
      { c: "Map", answerIndex: 25 },
      { d: "Chest", answerIndex: 25 }, //idk, I still think we need a text input here,,,and piano music pleaseee
    ],
  },
  {
    eventIndex: 26,
    ...
    options: [
      { a: "Left", answerIndex: 27 },
      { b: "Right", answerIndex: 28 },
      { c: "" },
      { d: "" },
    ],
  },
  {
    ...
    options: [
      { a: "Take it", answerIndex: 29 }, //I'm not sure what to put here cause we haven't figured out the whole negative/positive thing yet,,,
      { b: "" },
      { c: "" },
      { d: "" },
    ],
  ...
  },
  {
    ...
    options: [
      { a: "Fight", answerIndex: 32 },
      { b: "Befriend", answerIndex: 33 },
      { c: "" },
      { d: "" },
    ],
  },
